...
const IdPage = () => {
  ...
  return (
    <div className="w-full felx flex-col pt-12 px-8 pb-8">
      <div className="w-max mt-6 border-b border-gray-200 flex flex-row">
        {/* 제목 가로길이 수정 필요 */}
              ...
              <div className="flex flex-col">
                ...
                <div>
                  <div className="gap-[18px] flex flex-row">
                    ...
                    {inId.time != "0" ? (
                      <div className={setColor(parseInt(inId.time))}>인기 {inId.best}위</div>
                    ) : (
                      <></>
                    )}
